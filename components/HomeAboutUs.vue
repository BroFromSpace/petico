<template>
	<section class="section section-decorated-1">
		<div class="decor-1">
			<NuxtImg src="bubbles-219x209.png" alt="" width="219" height="209" loading="lazy" />
		</div>
		<div class="decor-2">
			<NuxtImg src="bubbles-224x306.png" alt="" width="224" height="306" loading="lazy" />
		</div>
		<div class="container">
			<div class="row row-50 justify-content-center justify-content-lg-between flex-lg-row-reverse align-items-center">
				...
				<div class="col-md-10 col-lg-6 aos-outer">
					<NuxtImg class="img-responsive aos" data-aos="slide-in-left" src="about-501-526.jpg" alt="" loading="lazy" />
				</div>
			</div>
		</div>
	</section>
